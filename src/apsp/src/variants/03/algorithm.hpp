...
up(utilz::matrices::square_matrix<utilz::matrices::square_matrix<T, A>, U>& blocks, utilz::memory::buffer& b)
{
...
down(utilz::matrices::square_matrix<utilz::matrices::square_matrix<T, A>, U>& blocks, utilz::memory::buffer& b, support_arrays<T> o)
{
  using size_type  = typename utilz::matrices::traits::matrix_traits<utilz::matrices::square_matrix<utilz::matrices::square_matrix<T, A>, U>>::size_type;
  using value_type = typename utilz::matrices::traits::matrix_traits<utilz::matrices::square_matrix<utilz::matrices::square_matrix<T, A>, U>>::value_type;
...
void
calculate_diagonal(utilz::matrices::square_matrix<T, A>& mm, support_arrays<T>& support_arrays)
{
...
template<typename T, typename A>
void
calculate_horizontal(utilz::matrices::square_matrix<T, A>& im, utilz::matrices::square_matrix<T, A>& mm, support_arrays<T>& support_arrays)
{
  using size_type  = typename utilz::matrices::traits::matrix_traits<utilz::matrices::square_matrix<T, A>>::size_type;
  using value_type = typename utilz::matrices::traits::matrix_traits<utilz::matrices::square_matrix<T, A>>::value_type;
...
template<typename T, typename A>
void
calculate_vertical(utilz::matrices::square_matrix<T, A>& mi, utilz::matrices::square_matrix<T, A>& mm, support_arrays<T>& support_arrays)
{
  using size_type  = typename utilz::matrices::traits::matrix_traits<utilz::matrices::square_matrix<T, A>>::size_type;
  using value_type = typename utilz::matrices::traits::matrix_traits<utilz::matrices::square_matrix<T, A>>::value_type;
  using pointer    = typename utilz::matrices::traits::matrix_traits<utilz::matrices::square_matrix<T, A>>::pointer;
...
template<typename T, typename A>
void
calculate_peripheral(utilz::matrices::square_matrix<T, A>& ij, utilz::matrices::square_matrix<T, A>& ik, utilz::matrices::square_matrix<T, A>& kj)
{
...
template<typename T, typename A, typename U>
__hack_noinline void
run(utilz::matrices::square_matrix<utilz::matrices::square_matrix<T, A>, U>& blocks, support_arrays<T>& support_arrays)
{
  using size_type  = typename utilz::matrices::traits::matrix_traits<utilz::matrices::square_matrix<T, A>>::size_type;
#ifdef _OPENMP
